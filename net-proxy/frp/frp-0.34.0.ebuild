...
SRC_URI="https://github.com/fatedier/frp/archive/v${PV}/${P}.tar.gz
	${EGO_SUM_SRC_URI}"
LICENSE="Apache-2.0"
SLOT="0"
KEYWORDS="amd64"
...
src_compile() {
	go build -o bin/frpc ./cmd/frpc || die "failed to build client"
	go build -o bin/frps ./cmd/frps || die "failed to build server"
}
...
src_install() {
	...
	systemd_dounit conf/systemd/frp*.service
}
